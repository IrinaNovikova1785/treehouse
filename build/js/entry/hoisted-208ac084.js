const t = (t, e = 1e4) => (
  ...
  i = function (t, n = void 0) {
    return (
      !(!t || t === document.body || (n && t === n)) &&
      (e(t) ? t : i(t.parentElement, n))
    );
  },
  n = function (t) {
...
class I extends g {
  ...
  calculateBounds() {
    ...
    if (!0 === d || (s && d === s))
      ...
      if (
        (s.width === u && (f = s.width), s.width === p && (g = s.height), e > f)
      ) {
        (c = 0.5 * (e - f)), (r = -1 * c);
      ...
      if (
        (o > f && e < f && ((r -= 0.5 * (o - f)), (c -= 0.5 * (o - f))), i > g)
      ) {
        (h = 0.5 * (i - g)), (l = -1 * h);
  ...
  zoomTo(
    t = 1,
    { friction: e = z, originX: i = z, originY: n = z, event: s } = {},
  ) {
...
class V extends _ {
  ...
  onRefresh() {
    ...
    n &&
      ...
      s.removeAttribute(X),
      t.isInfinite ||
        (i <= 0 && n.setAttribute(X, ""), i >= e - 1 && s.setAttribute(X, "")));
  }
  addBtn(t) {
    var e;
...
class Q extends g {
  ...
  lazyLoadImg(t, e) {
    ...
    P(e, o),
      ...
      setTimeout(() => {
        ...
        i &&
          t.el &&
          (e.complete ? l() : a || ((r = n(x)), i.insertBefore(r, e)));
      }, 300);
  }
  lazyLoadSlide(t) {
    const e = t && t.el;
  ...
  updateMetrics() {
    ...
    (h = t(h, 1e3)),
      ...
      e &&
        ((e.contentRect[r] = h),
        (e.contentRect[o ? "fullWidth" : "fullHeight"] = h)),
      ...
      if (n && s) {
        ...
        (e = o || i.option("slug") || ""),
          ...
          e &&
            "true" !== e &&
            (t =
              "#" + e + (!o && n.slides.length > 1 ? "-" + (s.index + 1) : ""));
      }
    }
...
class It extends _ {
  ...
  createProgressBar() {
    ...
    const e = this.instance,
      i =
        (null === (t = e.pages[e.page]) || void 0 === t ? void 0 : t.slides) ||
        [];
...
class Oe extends g {
  ...
  initCarousel(t) {
    ...
    s.on("*", (t, e, ...i) => {
      ...
      s.on("change", (t) => {
        var e;
        let i =
          null === (e = this.getSlide()) || void 0 === e ? void 0 : e.triggerEl;
        if (i) {
  ...
  isTopmost() {
    var t;
    return (
      (null === (t = Oe.getInstance()) || void 0 === t ? void 0 : t.id) ==
      this.id
    );
  }
  animate(t = null, e = "", i) {
  ...
  isOpeningSlide(t) {
    ...
    return (
      null ===
        (null === (e = this.carousel) || void 0 === e ? void 0 : e.prevPage) &&
      t &&
      t.index ===
  ...
  static unbind(t, e) {
    let i,
      n = "";
    if (
      (ve(t) ? ((i = document.body), (n = t)) : ((i = t), ve(e) && (n = e)), !i)
    )
      return;
    const s = Oe.openers.get(i);
    s && n && s.delete(n),
      (n && s) ||
        (Oe.openers.delete(i), i.removeEventListener("click", Oe.fromEvent));
  }
  static destroy() {
    let t;
  ...
  static getSlide() {
    var t;
    return (
      (null === (t = Oe.getInstance()) || void 0 === t
        ? void 0
        : t.getSlide()) || null
    );
  }
...
dropdownItems.forEach((item) => {
  ...
  if (tabId) {
    ...
    if (firstMenuLink) addClass(firstMenuLink, "dropdown-column__link--active");
...
export { Accordion as A, Oe as O, getDefaultExportFromCjs as g };
